...
/** @type {string} */
const CACHE_VERSION = '1724237171|705736252';
/** @type {string} */
const CACHE_PREFIX = 'ScaleToExit-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'ScaleToExit.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["ScaleToExit.html","ScaleToExit.js","ScaleToExit.offline.html","ScaleToExit.icon.png","ScaleToExit.apple-touch-icon.png","ScaleToExit.worker.js","ScaleToExit.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["ScaleToExit.wasm","ScaleToExit.pck","ScaleToExit.side.wasm","liblimboai.web.template_debug.wasm32.wasm"];
